use empregados_marcio;

select * from empregado;

select * from dependente;

select * from dependente where cod_emp in(select cod_emp from empregado where civil like 'V');

select * from dependente where cod_emp in(select cod_emp from empregado where dt_nascimento <'1984-09-09');

select * from dependente where cod_emp in(select cod_emp from empregado where dt_admissao <'2019-09-09');
